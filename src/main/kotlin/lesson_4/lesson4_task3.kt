...
fun main() {
    ...
    println("Благоприятные ли условия сейчас для роста бобовых? ${(weatherIsSunny == REQUIRED_WEATHER_IS_SUNNY) && (tentIsOpen == REQUIRED_TENT_IS_OPEN) && (airHumidityPercent == REQUIRED_AIR_HUMIDITY_PERCENT) && (currentSeason != EXCEPTIONAL_SEASON)}")
}